      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:py-14">
        ...
        <div className="flex flex-col items-start justify-between gap-8 md:flex-row">
          ...
          <nav className="grid grid-cols-2 gap-4 text-sm md:grid-cols-4">
            ...
            <Link href="/auth" className="text-white/80 hover:text-white">Giriş / Kayıt</Link>
          </nav>
        </div>
        ...
        <div className="mt-8 flex flex-col items-start justify-between gap-6 border-t border-white/10 pt-8 md:flex-row md:items-center">
          <div className="flex flex-wrap items-center gap-3 text-sm">
            <a href="tel:05015303949" className="rounded-xl border border-white/15 bg-white/5 px-3 py-2 hover:bg-white/10">📞 0501 530 39 49</a>
            <a href="mailto:info@paletevreni.com" className="rounded-xl border border-white/15 bg-white/5 px-3 py-2 hover:bg-white/10">✉️ info@paletevreni.com</a>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={scrollTop} className="ml-2 rounded-full border border-white/15 bg-white/10 px-3 py-2 text-sm text-white/80 hover:bg-white/20" aria-label="Yukarı çık">
              ↑ Yukarı
            </button>
          </div>
        </div>
