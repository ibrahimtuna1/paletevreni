      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-2 pt-8">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-10">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="mt-2 space-y-2 text-[15px] text-white/85">
            ...
            <ul className="mt-2 space-y-2 text-[15px] text-white/85">
              <li>
                <a
                  ...
                  className="flex items-center justify-center sm:justify-end gap-2 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 rounded-sm"
                >
                  <span>Instagram</span>
                  <IconInstagram />
                </a>
              ...
              {/* LinkedIn & YouTube bilinçli olarak kaldırıldı */}
            </ul>
          </div>
        </div>
      </div>
